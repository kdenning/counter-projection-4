...
## Projection using Everyday Likes (ED)
...
## Projection using BFI + ED combined

```{r data prep for combined EDBFI models}
...
# Pre-registered Model 2: Stereotyping predicted by group
...
### Plot: Interaction between group and identification on projection
...
### Plot: Main effect target group on projection
...
### Plot: Group x stereotyping on projection
...
### Plot: Identification on stereotyping, no projection
