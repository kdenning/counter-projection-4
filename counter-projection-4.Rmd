...
```{r model 1 results}
model1 <- lmer(Targ ~ self_c*group_cond + (self_c|sub_id),
               data = model1_data)
summary(model1)
```
...
model2ED_nostereo <- lmer(Targ ~ self_c*group_cond + (self_c|sub_id),
               data = model2ED_data)
...
model2EDwstereo <- lmer(Targ ~ self_c*group_cond*stereoED_c + (1|sub_id),
               data = model2ED_data)
...
model2_bfistereo_resuts <- lmer(Targ ~ self_c*group_cond*stereoBFI_c + (self_c |sub_id), data = model2_bfistereo)
...
model3EDBFI_stereo <- lmer(Targ ~ self_c*group_cond*stereo_c*identification_c + (self_c|sub_id), data = EDBFI_data)
