...
indivdiff_data <- EDBFI_overall %>% 
  ...
  mutate(perceive_polar = abs(lib - cons),
         perceive_polar_c = perceive_polar - mean(perceive_polar, na.rm = TRUE))#getting variable for perceived polar by subtracting perceived polarization for conservatives from liberals and getting teh absolute value of that diff
