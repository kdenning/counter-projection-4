...
Both projection and stereotyping plots are the same as the results from Model 3 using ED and BFI, indicating that adding identification into the model with the combined scales had not impact on the main effects of projection and stereoyping by group.
